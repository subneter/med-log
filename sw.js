...
self.addEventListener('fetch', function(e){
  ...
  if(/dubaicityofgold\.com|allorigins|corsproxy|r\.jina\.ai|oembed|vimeo\.com\/api|news\.google\.com|youtube\.com\/feeds|api\.github\.com/.test(e.request.url)) return;
